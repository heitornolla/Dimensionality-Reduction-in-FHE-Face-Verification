...
if __name__ == "__main__":
    ...
    for i in range(10):
        print(f'--- RUN {i+1} ---\n')
        print('\nRunning JL\n')
        jl_reduction(csv_path='results/jl_results')
        print('\nRunning AE\n')
        ae_reduction(csv_path='results/ae_results')
        print('\nRunning PCA\n')
        pca_reduction(csv_path='results/pca_results')
        print('\nRunning GRP\n')
        grp_reduction(csv_path='results/grp_results')
        print('\nRunning SRP\n')
        srp_reduction(csv_path='results/srp_results')
        print('\nRunning RSVD\n')
        rsvd_reduction(csv_path='results/rsvd_results')
